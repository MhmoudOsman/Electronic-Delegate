...
public class PharmacyOrderModel {
    ...
    public PharmacyOrderModel(String order_image, String order_name, String pharmacy_name, String order_price, String order_location, String order_quantity, String payment) {
